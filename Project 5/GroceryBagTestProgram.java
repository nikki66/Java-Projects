public class GroceryBagTestProgram {
    public static void main(String args[]) {
        ...
        g2 = new FreezerItem("Smart-Ones Frozen Entrees", 1.99f, 0.311f);//took off true(DONT NEED TO BUT JUST FOR RUNNING)
        g3 = new GroceryItem("SnackPack Pudding", 0.99f, 0.396f);
        g4 = new GroceryItem("Nabob Coffee", 3.99f, 0.326f);
        g5 = new FreezerItem("Fresh Salmon", 4.99f, 0.413f);//took off true(DONT NEED TO BUT JUST FOR RUNNING)
