public class ShopperTestProgram {//Assignment4 question 2 part3 changed GroceryItem?
    public static void main(String args[]) {
        GroceryItem g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11, g12, g13, g14, g15;
        g1 = new FreezerItem("Smart-Ones Frozen Entrees",1.99f,0.311f);//took off true //adjusted for q3
        g2 = new GroceryItem("SnackPack Pudding",0.99f,0.396f);
        g3 = new FreezerItem("Breyers Chocolate Icecream",2.99f,2.27f);//took off true /adjusted for q3
        ...
        g8 = new RefrigeratorItem("Lean Ground Beef",4.94f,0.75f);//took off true /adjusted for q3
        g9 = new FreezerItem("5-Alive Frozen Juice",0.75f,0.426f);//took off true /adjusted for q3
...
//        }
        ...
        PerishableItem[] remove = c.removePerishables();
        for(int l=0;l<remove.length;l++) {
            System.out.println(remove[l]);
        }
        //System.out.println(c.removePerishables());
